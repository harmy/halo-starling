...
package core.object
{
	 ...
	 *  </ul> 
	 */
	public class HaloTextField extends DisplayObjectContainer
	{
		...
		public function HaloTextField(width:int, height:int, text:String, fontName:String="Verdana",
		...
		private function createRenderedContents():DisplayObject
		{
			...
			sNativeTextField.filters = mFilter;
			...
			var contents:Image = new Image(Texture.fromBitmapData(bitmapData, false, false));
		...
		/** The displayed text. */
		public function get filter():Array { return mFilter; }
